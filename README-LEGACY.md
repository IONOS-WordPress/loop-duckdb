...
_This document contains legacy information on how to use duckdb to work on loop data. Please head over to [README.md](./README.md) to read the up to date information.
